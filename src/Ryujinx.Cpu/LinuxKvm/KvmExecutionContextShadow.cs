...
{
    class KvmExecutionContextShadow : IKvmExecutionContext
    {
        public ulong Pc { get; set; }
        public ulong ElrEl1 { get; set; }
        public ulong EsrEl1 { get; set; }
        public ulong FarEl1 { get; set; }
        public ulong SpsrEl1 { get; set; }
        public ulong MdscrEl1 { get; set; }
        public ulong SpEl0 { get; set; }
        ...
        public KvmExecutionContextShadow()
        {
            _x = new ulong[32];
            _v = new V128[32];
        }
