...
{
    interface IKvmExecutionContext
    {
        ulong Pc { get; set; }
        ulong ElrEl1 { get; set; }
        ulong EsrEl1 { get; set; }
        ulong FarEl1 { get; set; }
        ulong SpsrEl1 { get; set; }
        ulong MdscrEl1 { get; set; }
        ulong SpEl0 { get; set; }
        ...
        public void Load(IKvmExecutionContext context)
        {
            Pc = context.Pc;
            ElrEl1 = context.ElrEl1;
            EsrEl1 = context.EsrEl1;
            FarEl1 = context.FarEl1;
            SpsrEl1 = context.SpsrEl1;
            MdscrEl1 = context.MdscrEl1;
            SpEl0 = context.SpEl0;
